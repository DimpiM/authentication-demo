 ...
 */
exports.randomBase64URLBuffer = (len) => {
    len = len || 32;
 ...
 */
exports.generateServerMakeCredRequest = (userName, id) => {
    return {
 ...
 */
exports.generateServerGetAssertion = (authenticators) => {
...
exports.verifyAuthenticatorAttestationResponse = (webAuthnResponse) => {
...
exports.verifyAuthenticatorAssertionResponse = (webAuthnResponse, authenticators) => {
